...
export const BottomTabProvider = ({children}) => {
    ...
    AboutApp            {1,app, no_tickets}
    AboutUserMini   {2, user, since_week}
    AboutDay            {3, day}
    */
    ...
    <BottomTabContext.Provider value={value}>
        ...
        {object && object.id === 1 && <AboutApp app={object.object} noTickets={object.no_tickets}                      onClose={()=>setObject(null)}/>}
        {object && object.id === 2 && <AboutUserMini user={object.object} sinceWeek={object.since_week}       onClose={()=>setObject(null)}/>}
