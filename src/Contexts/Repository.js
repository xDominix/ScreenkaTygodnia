...
const PostRepository = [
    new Post("dsnanaaiaocsn","-1","Glassy Week",new Date(2023,4-1,24,14,0),"Safari","https://open.spotify.com/track/2dHHgzDwk4BJdRwy9uXhTO","To wszystko sie tu zaczelo!",true,null,null,null,null),
...
export const UserRepository = [
    new UserClass("Giorgio Armani1","giogo","giogo.jpg",["-1"],["Maps"],PostRepository),
...
const MemberRepository = [
    new Member("Giorgio Armani1",new Date(2023,4-1,17)),
...
const WeekRepository = [
    new Week("Glassy Week",new Date(2023,4-1,24,8,0),"New week, new you. Have fun. We are waiting for some new fresh and dope things! Use your glasses against burning sun! ...","🕶️",SpecialDays,true,true,true,null,null,null,true)
]
export const TeamRepository = [
    new Team("-1","Giorgio Armani1",new Date(2023,4-1,17),MemberRepository,
    ["Word","Sentence",
